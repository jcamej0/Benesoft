...
app.controller('ayudantiaRegistro', function($scope, $http, $mdToast, $mdDialog, $mdMedia, $window, $filter) {
...
app.controller('consultaAyudantia', function($scope, $http, $mdDialog, $window) {
...
app.controller('consultaControlAyudantia', function($scope, $http, $stateParams, $mdDialog, $mdMedia, $window) {
    ...
    $scope.eliminar = function() {
        ...
        $http.delete('eliminarAyudantia', { params: { cedula: $scope.cedula } }).success(function(data) {
            ...
            $window.location.href = 'dashboard#/pya/consultar/ayudantia'
...
app.controller('ayudantiaReporte', function($scope, $http) {
    ...
    $http.get('/beneficiariosAyudantia', { params: { beneficio: $scope.beneficio } }).success(function(data) {
        ...
        columns: [
            ...
            content: [
                { text: 'Listado de Ayudantias', style: 'headerprincipal' }, {
                    style: 'demoTable',
                    table: {
                        widths: ['*', '*', '*', '*'],
                        body: [
...
app.controller('ayudantiaEstadisticas', function($scope, $http, $stateParams, $mdDialog, $mdToast, $window, $filter) {
