...
app.controller('socialRegistro', function($scope, $http, $mdToast, $mdDialog, $mdMedia, $window, $filter) {
                    ...
                    $http.get('/verificarExpediente', { params: {cedula: data.cedula } }).success(function(respuesta) {
                            ...
                            if (respuesta == "expediente") {
                                ...
                                $mdDialog.show(confirm).then(function() {
                                    ...
                                    $window.location.href = 'dashboard#/socialcritica'
...
app.controller('modificarSocialCritica', function($scope, $http, $stateParams, $mdDialog, $mdToast, $window, $filter) {
...
app.controller('consultaSocialCritica', function($scope, $http, $mdDialog, $window) {
...
app.controller('socialestadisticas', function($scope, $http) {
...
app.controller('socialReporte', function($scope, $http) {
    ...
    $http.get('/beneficiarios', { params: { beneficio: $scope.beneficio } }).success(function(data) {
        ...
        columns: [
            ...
            content: [
                { text: 'Listado estudiantes Beca Social Critica', style: 'headerprincipal' }, {
                    style: 'demoTable',
                    table: {
                        widths: ['*', '*', '*','*', '*'],
                        body: [
