...
app.controller('preparaduriaRegistro', function($scope, $http, $mdToast, $mdDialog, $mdMedia, $window, $filter) {
    ...
    $scope.agregarBeneficiarios = function() {
        ...
        data = {
            ...
            fecnac: fecha,
            fecinicio: fecinicio,
            depasignado: $scope.formulario.depasignado,
        ...
        if (data.civil == undefined || data.residencia == undefined || data.paga == undefined || data.monto == undefined ||
            ...
            $http.post('/agregarPreparaduria', data).success(function(respuesta) {
                ...
                if (respuesta == "ERROR") {
                    ...
                    $mdToast.show(
                        $mdToast.simple()
                        .textContent('Cedula o codigos ya registrados')
                        .position('bottom')
                        .hideDelay(3000)
                    );
                } else if (respuesta == "registrado") {
...
app.controller('consultaPreparaduria', function($scope, $http, $mdDialog, $window) {
...
app.controller('consultaControlPreparaduria', function($scope, $http, $stateParams, $mdDialog, $mdMedia, $window) {
    ...
    $scope.eliminar = function() {
        ...
        $http.delete('eliminarPreparaduria', { params: { cedula: $scope.cedula } }).success(function(data) {
            ...
            $window.location.href = 'dashboard#/pya/consultar/preparaduria'
...
app.controller('modificarPreparaduria', function($scope, $http, $stateParams, $mdDialog, $mdToast, $window, $filter) {
    ...
    $scope.actualizarBeneficiario = function() {
        ...
        $scope.informacion = {
            ...
            fecinicio: $scope.formulario.fecinicio,
            depasignado: $scope.formulario.depasignado,
            correo: $scope.formulario.correo,
            facebook: $scope.formulario.facebook,
            twitter: $scope.formulario.twitter,
...
app.controller('preparaduriaReporte', function($scope, $http) {
    ...
    $http.get('/beneficiariosPreparaduria', { params: { beneficio: $scope.beneficio } }).success(function(data) {
        ...
        columns: [
            ...
            content: [
                { text: 'Listado de preparadores', style: 'headerprincipal' }, {
                    style: 'demoTable',
                    table: {
                        widths: ['*', '*', '*', '*'],
                        body: [
                            [{ text: 'Apellidos', style: 'header' }, { text: 'Nombres', style: 'header' },
                                { text: 'Pnf', style: 'header' }, { text: 'Departamento', style: 'header' }
                            ],
        ...
        for (var i = 0; i < $scope.beneficiarios.length; i++) {
            ...
            docDefinition.content[1].table.body[i + 1].push($scope.beneficiarios[i].depasignado);
            arreglo = [];
            arreglomayor = [];
...
app.controller('preparaduriaEstadisticas',function($scope, $http, $stateParams, $mdDialog, $mdToast, $window, $filter){
