...
app.controller('deporteRegistro', function($scope, $http, $mdToast, $mdDialog, $mdMedia, $window, $filter) {
                ...
                $http.get('/verificarExpediente', { params: { cedula: data.cedula } }).success(function(respuesta) {
                    ...
                    if (respuesta == "expediente") {
                        ...
                        $mdDialog.show(confirm).then(function() {
                            ...
                            $window.location.href = 'dashboard#/deporte'
...
app.controller('modificarDeporte', function($scope, $http, $stateParams, $mdDialog, $mdToast, $window, $filter) {
 ...
 if (respuesta=='Error') {
            ...
            $window.location.href = 'dashboard#/deporte/consultar'
...
app.controller('consultaDeporte', function($scope, $http, $mdDialog, $window) {
...
app.controller('deporteestadisticas', function($scope, $http) {



    $http.get('/informacion', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion1', { params: { beneficio: 'Deporte' } }).success(function(data) {

        $scope.totalbeneficiarioshombres = data;

    });

    $http.get('/informacion2', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion3', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion4', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion5', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion6', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion7', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion8', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion9', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion10', { params: { beneficio: 'Deporte' } }).success(function(data) {
    ...
    $http.get('/informacion11', { params: { beneficio: 'Deporte' } }).success(function(data) {
...
app.controller('deporteReporte', function($scope, $http) {
...
header: function(){
        ...
        columns: [
            ...
            content: [
                { text: 'Listado estudiantes Beca Deporte', style: 'headerprincipal' }, {
                    style: 'demoTable',
                    table: {
                        widths: ['*', '*', '*', '*', '*'],
                        body: [
