...
app.controller('discapacidadRegistro', function($scope, $http, $mdToast, $mdDialog, $mdMedia, $window, $filter) {
                ...
                $http.get('/verificarExpediente', { params: { cedula: data.cedula } }).success(function(respuesta) {
                    ...
                    if (respuesta == "expediente") {
                        ...
                        $mdDialog.show(confirm).then(function() {
                            ...
                            $window.location.href = 'dashboard#/discapacidad'
...
app.controller('modificarDiscapacidad', function($scope, $http, $stateParams, $mdDialog, $mdToast, $window, $filter) {
 ...
 if (respuesta=='Error') {
            ...
            $window.location.href = 'dashboard#/discapacidad/consultar'
...
app.controller('consultaDiscapacidad', function($scope, $http, $mdDialog, $window) {
...
app.controller('discapacidadestadisticas', function($scope, $http) {
...
app.controller('discapacidadReporte', function($scope, $http) {
...
header: function(){
        ...
        columns: [
            ...
            content: [
                { text: 'Listado estudiantes Beca Discapacidad', style: 'headerprincipal' }, {
                    style: 'demoTable',
                    table: {
                        widths: ['*', '*', '*', '*', '*'],
                        body: [
